...
<head>
    ...
    <title>BMI Calculator - Body Mass Index Calculator Online Free</title>
    <meta name="description" content="Free BMI calculator online. Calculate your Body Mass Index with weight, height. Know if you're underweight, normal, overweight, or obese!">
    <meta name="keywords" content="BMI calculator, body mass index calculator, bmi calculator, calculate bmi, healthy weight, obesity calculator, fitness calculator, health index">
...
<body>
    ...
    <div class="card border-0 shadow-sm text-white mb-4" style="background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%);">
        <div class="card-body p-4 p-md-5 text-center">
            ...
            <h2 class="display-5 mb-3">❤️ BMI Calculator - Body Mass Index Calculator Online Free</h2>
