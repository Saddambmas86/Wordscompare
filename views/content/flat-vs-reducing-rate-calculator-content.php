...
<p class="text-center mt-3">Looking for more? Use our <a href="<?php echo $base_url; ?>hra-calculator">Hra Calculator</a> and <a href="<?php echo $base_url; ?>age-calculator">Age Calculator</a> for fast and accurate results.</p>
 </div>
 </div>
