...
<p class="text-center mt-3">Looking for more? Use our <a href="<?php echo $base_url; ?>json-to-pdf">Json To Pdf</a> and <a href="<?php echo $base_url; ?>ipynb-to-pdf">Ipynb To Pdf</a> for fast and accurate results.</p>
 </div>
 </div>
