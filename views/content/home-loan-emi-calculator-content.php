...
<p class="text-center mt-3">Looking for more? Use our <a href="<?php echo $base_url; ?>epf-calculator">Epf Calculator</a> and <a href="<?php echo $base_url; ?>refinance-calculator">Refinance Calculator</a> for fast and accurate results.</p>
 </div>
 </div>
