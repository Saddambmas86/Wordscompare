...
<p class="text-center mt-3">Looking for more? Use our <a href="<?php echo $base_url; ?>rtf-to-pdf">Rtf To Pdf</a> and <a href="<?php echo $base_url; ?>add-page-number-to-pdf">Add Page Number To Pdf</a> for fast and accurate results.</p>
 </div>
 </div>
