...
<p class="text-center mt-3">Looking for more? Use our <a href="<?php echo $base_url; ?>sip-calculator">Sip Calculator</a> and <a href="<?php echo $base_url; ?>brokerage-calculator">Brokerage Calculator</a> for fast and accurate results.</p>
 </div>
 </div>
