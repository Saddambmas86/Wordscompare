...
<p class="text-center mt-3">Looking for more? Use our <a href="<?php echo $base_url; ?>investment-returns-calculator">Investment Returns Calculator</a> and <a href="<?php echo $base_url; ?>simple-calculator">Simple Calculator</a> for fast and accurate results.</p>
 </div>
 </div>
