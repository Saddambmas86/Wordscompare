...
<p class="text-center mt-3">Looking for more? Use our <a href="<?php echo $base_url; ?>lock-pdf">Lock Pdf</a> and <a href="<?php echo $base_url; ?>offer-letter-generator">Offer Letter Generator</a> for fast and accurate results.</p>
 </div>
 </div>
