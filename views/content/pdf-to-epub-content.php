...
<p class="text-center mt-3">Looking for more? Use our <a href="<?php echo $base_url; ?>text-to-pdf">Text To Pdf</a> and <a href="<?php echo $base_url; ?>repair-pdf">Repair Pdf</a> for fast and accurate results.</p>
 </div>
 </div>
