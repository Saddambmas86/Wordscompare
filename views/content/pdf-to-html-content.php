...
<head>
    ...
    <title>Pdf To Html - Free Online Tool</title>
    <meta name="description" content="Free Pdf To Html online. Convert files instantly and securely.">
    <meta name="keywords" content="pdf to html, online pdf to html, free pdf to html, convert pdf, pdf converter">
    ...
    <div class="container mb-5">
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-header bg-white border-0 py-3">
                <h3 class="h2 mb-0 text-center fw-bold"><i class="fas fa-cogs me-2 text-primary"></i>How to use Pdf To Html</h3>
            </div>
