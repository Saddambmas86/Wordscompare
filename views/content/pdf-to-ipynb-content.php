...
<p class="text-center mt-3">Looking for more? Use our <a href="<?php echo $base_url; ?>compress-pdf">Compress Pdf</a> and <a href="<?php echo $base_url; ?>csv-to-pdf">Csv To Pdf</a> for fast and accurate results.</p>
 </div>
 </div>
