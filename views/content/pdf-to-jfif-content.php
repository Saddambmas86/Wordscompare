...
<p class="text-center mt-3">Looking for more? Use our <a href="<?php echo $base_url; ?>jpg-to-pdf">Jpg To Pdf</a> and <a href="<?php echo $base_url; ?>pdf-to-text">Pdf To Text</a> for fast and accurate results.</p>
 </div>
 </div>
