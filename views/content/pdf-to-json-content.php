...
<p class="text-center mt-3">Looking for more? Use our <a href="<?php echo $base_url; ?>speech-to-pdf">Speech To Pdf</a> and <a href="<?php echo $base_url; ?>pdf-to-mobi">Pdf To Mobi</a> for fast and accurate results.</p>
 </div>
 </div>
