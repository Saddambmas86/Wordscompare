...
<p class="text-center mt-3">Looking for more? Use our <a href="<?php echo $base_url; ?>pdf-to-mobi">Pdf To Mobi</a> and <a href="<?php echo $base_url; ?>pdf-to-json">Pdf To Json</a> for fast and accurate results.</p>
 </div>
 </div>
