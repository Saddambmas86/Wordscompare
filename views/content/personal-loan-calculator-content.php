...
<p class="text-center mt-3">Looking for more? Use our <a href="<?php echo $base_url; ?>cagr-calculator">Cagr Calculator</a> and <a href="<?php echo $base_url; ?>apy-calculator">Apy Calculator</a> for fast and accurate results.</p>
 </div>
 </div>
