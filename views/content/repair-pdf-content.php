...
<p class="text-center mt-3">Looking for more? Use our <a href="<?php echo $base_url; ?>payroll-sheet-generator">Payroll Sheet Generator</a> and <a href="<?php echo $base_url; ?>split-pdf">Split Pdf</a> for fast and accurate results.</p>
 </div>
 </div>
