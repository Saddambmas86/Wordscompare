...
<p class="text-center mt-3">Looking for more? Use our <a href="<?php echo $base_url; ?>car-loan-emi-calculator">Car Loan Emi Calculator</a> and <a href="<?php echo $base_url; ?>gst-calculator">Gst Calculator</a> for fast and accurate results.</p>
 </div>
 </div>
