...
<p class="text-center mt-3">Looking for more? Use our <a href="<?php echo $base_url; ?>pdf-to-ipynb">Pdf To Ipynb</a> and <a href="<?php echo $base_url; ?>epub-to-pdf">Epub To Pdf</a> for fast and accurate results.</p>
 </div>
 </div>
