...
<p class="text-center mt-3">Looking for more? Use our <a href="<?php echo $base_url; ?>tax-calculator">Tax Calculator</a> and <a href="<?php echo $base_url; ?>discount-calculator">Discount Calculator</a> for fast and accurate results.</p>
 </div>
 </div>
