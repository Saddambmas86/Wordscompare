...
<head>
    ...
    <title>Text To Pdf - Free Online Tool</title>
    <meta name="description" content="Free Text To Pdf online. Convert files instantly and securely.">
    <meta name="keywords" content="text to pdf, online text to pdf, free text to pdf, convert pdf, pdf converter">
...
<body>
    ...
    <div class="card border-0 shadow-sm text-white mb-4" style="background: linear-gradient(135deg, #f5576c 0%, #f093fb 100%);">
        <div class="card-body p-4 p-md-5 text-center">
            ...
            <h2 class="display-5 mb-3">⚡ Text To Pdf - Fast & Free Online</h2>
            <p class="lead mb-0">Free Text To Pdf online. Convert files instantly and securely.</p>
        </div>
    </div>
    ...
    <div class="container mb-5">
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-header bg-white border-0 py-3">
                <h3 class="h2 mb-0 text-center fw-bold"><i class="fas fa-cogs me-2 text-primary"></i>How to use Text To Pdf</h3>
            </div>
        ...
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body p-4 p-md-5">
                <div class="row g-4">
                    <div class="col-md-6">
                        <h5 class="fw-bold text-primary mb-3">Why use Text To Pdf?</h5>
                ...
                <div class="text-center mt-4 p-4" style="background: linear-gradient(135deg, #f5576c 0%, #f093fb 100%);; border-radius: 15px;">
                    <h4 class="text-white mb-3"><i class="fas fa-file-pdf me-2"></i>Use Text To Pdf Now!</h4>
