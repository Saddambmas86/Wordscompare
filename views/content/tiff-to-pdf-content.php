...
<p class="text-center mt-3">Looking for more? Use our <a href="<?php echo $base_url; ?>word-to-pdf">Word To Pdf</a> and <a href="<?php echo $base_url; ?>jfif-to-pdf">Jfif To Pdf</a> for fast and accurate results.</p>
 </div>
 </div>
