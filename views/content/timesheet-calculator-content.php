...
<p class="text-center mt-3">Looking for more? Use our <a href="<?php echo $base_url; ?>income-tax-calculator">Income Tax Calculator</a> and <a href="<?php echo $base_url; ?>ppf-calculator">Ppf Calculator</a> for fast and accurate results.</p>
 </div>
 </div>
