...
<p class="text-center mt-3">Looking for more? Use our <a href="<?php echo $base_url; ?>json-to-pdf">Json To Pdf</a> and <a href="<?php echo $base_url; ?>lock-pdf">Lock Pdf</a> for fast and accurate results.</p>
 </div>
 </div>
 ...
 <li>Raumur, Rankine, Newton, Delisle, Rmer</li>
 </ul>
 </div>
 </div>
 </div>
