...
<p class="text-center mt-3">Looking for more? Use our <a href="<?php echo $base_url; ?>pdf-to-excel">Pdf To Excel</a> and <a href="<?php echo $base_url; ?>jfif-to-pdf">Jfif To Pdf</a> for fast and accurate results.</p>
 </div>
 </div>
