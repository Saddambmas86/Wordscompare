...
<div class="card border-0 shadow-sm text-white mb-4"
    ...
    <div class="card-body p-4 p-md-5 text-center">
        ...
        <h2 class="display-5 mb-3"> Unlock Pdf - Fast & Free Online</h2>
        <p class="lead mb-0">Free Unlock Pdf online. Manage and edit your PDF files easily.</p>

        <p class="text-center mt-3">Looking for more? Use our <a href="<?php echo $base_url; ?>pdf-to-excel">Pdf To
                Excel</a> and <a href="<?php echo $base_url; ?>jfif-to-pdf">Jfif To Pdf</a> for fast and accurate
            results.</p>
    </div>
</div>
...
<div class="container mb-5">
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-header bg-white border-0 py-3">
            <h3 class="h2 mb-0 text-center fw-bold"><i class="fas fa-cogs me-2 text-primary"></i>How to use Unlock Pdf
            </h3>
        </div>
    ...
    <div class="card border-0 shadow-sm">
        ...
        <div class="card-body p-4 p-md-5">
            <div class="row g-4">
                <div class="col-md-6">
                    <h5 class="fw-bold text-primary mb-3">Why use Unlock Pdf?</h5>
            ...
            <div class="text-center mt-4 p-4"
                ...
                <h4 class="text-white mb-3"><i class="fas fa-file-pdf me-2"></i>Use Unlock Pdf Now!</h4>
