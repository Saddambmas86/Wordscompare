        ...
        <div class="row justify-content-center px-2">
            <div class="col-12 p-3 p-md-4 rounded shadow">
                <div class="text-center mb-4 mb-md-5">
                    <h1 class="h2 fw-bold text-gray-800 mb-2">Car Loan EMI Calculator</h1>
                    <p class="lead text-gray-500 mx-auto" style="max-width: 700px">
                        Plan your car loan with confidence. Calculate your monthly EMI, total interest, and see a full amortization schedule.
                    </p>
                </div>
                            ...
                            <div class="space-y-4">
                                <div>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <label for="loan-amount" class="form-label mb-1">Car Loan Amount</label>
                                    ...
                                    <input type="range" id="loan-amount" min="100000" max="5000000" step="10000" value="1000000" class="form-range mt-2">
                                </div>

                                <div>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <label for="interest-rate" class="form-label mb-1">Interest Rate</label>
                                        <span class="h5 fw-semibold text-primary"><span id="interest-rate-text">9.0</span> %</span>
                                    </div>
                                    <input type="range" id="interest-rate" min="5" max="15" step="0.1" value="9.0" class="form-range mt-2">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="range" id="loan-tenure" min="1" max="7" step="1" value="5" class="form-range mt-2">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8 border shadow-sm">
            <article>
                ...
                <?php include '../../views/content/car-loan-emi-calculator-content.php'; ?>
