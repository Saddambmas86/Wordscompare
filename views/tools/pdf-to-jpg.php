...
$page_title = "PDF to JPG Converter"; // You may Change the Title here
$page_description = "PDF to JPG Converter online."; // Put your Description here
        ...
        <div class="col-lg-7 border shadow-sm">
            <div class="tool-container rounded-3 p-4 p-md-5">
                <header class="text-center mb-4">
                    <h1 class="h2">PDF to JPG Converter <i class="fas fa-file-image text-danger ms-2"></i></h1>
                    <p class="lead text-muted">Convert PDF pages into high-quality JPG images.</p>
                </header>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8 border shadow-sm">
            <article>
                ...
                <?php include '../../views/content/pdf-to-jpg-content.php'; ?>
            </article>
        </div>
    </div>
</div>
...
<script>
// JavaScript for PDF to JPG Converter
let files = [];
let imageData = [];
...
function showHowTo() {
    Swal.fire({
        title: 'Welcome to PDF to JPG Converter',
        ...
        <ol class="text-start">
            ...
            <li>Set your preferred image quality, format, and resolution.</li>
            <li>Click "Convert" to transform PDF pages into images.</li>
...
function resetAll() {
    ...
    document.getElementById('outputFormat').value = 'jpg';
...
async function convertPDFToImages() {
    ...
    try {
        ...
        Swal.fire({
            ...
            text: 'Your PDF has been successfully converted to images.',
            icon: 'success',
...
function createImagePreview(dataUrl, pageNum, fileName) {
    ...
    downloadBtn.addEventListener('click', (e) => {
        ...
        a.href = dataUrl;
        a.download = `${fileName.replace('.pdf', '')}_page${pageNum}.jpg`;
