...
$page_title = "PDF to TEXT Converter"; // You may Change the Title here
$page_description = "PDF to TEXT Converter online."; // Put your Description here
$page_keywords = "PDF to TEXT, convert PDF to TEXT, extract PDF text, PDF to plain text, PDF text extraction, free PDF converter, online PDF tool";
