...
$page_title = "PDF to WebP Converter - Convert PDF to WebP Images Online"; // You may Change the Title here
$page_description = "Convert PDF to WebP online for free. Transform PDF pages into modern WebP image format for fast web loading. High quality with smaller file sizes."; // Put your Description here
$page_keywords = "pdf to webp converter - convert pdf to webp images online, pdf, webp, converter, convert, images, online, free online tools, pdf tools";
        ...
        <div class="col-lg-7 border shadow-sm">
            <div class="tool-container rounded-3 p-4 p-md-5">
                <header class="text-center mb-4">
                    <h1 class="h2">PDF to WebP Converter <i class="fas fa-file-image text-danger ms-2"></i></h1>
                    <p class="lead text-muted">Convert PDF pages into high-quality WebP images.</p>
                </header>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8 border shadow-sm">
            <article>
                ...
                <?php include '../../views/content/pdf-to-webp-content.php'; ?>
            </article>
        </div>
    </div>
</div>
...
<script>
// JavaScript for PDF to WebP Converter
let files = [];
let imageData = [];
...
function showHowTo() {
    Swal.fire({
        title: 'Welcome to PDF to WebP Converter',
        ...
        <ol class="text-start">
            ...
            <li>Set your preferred image quality (50% is recommended for web use), format (WebP is recommended), and resolution (72 DPI is ideal for web).</li>
            <li>Click "Convert" to transform PDF pages into WebP images.</li>
...
async function convertPDFToImages() {
    ...
    showStatus('Converting PDF to WebP images...', 'info');
    convertBtn.disabled = true;
    ...
    try {
        ...
        for (const file of files) {
            ...
            for (const pageNum of pageRange) {
                ...
                if (outputFormat === 'webp') {
                    imageDataUrl = await canvasToWebP(canvas, quality);
                } else {
                    imageDataUrl = canvas.toDataURL(`image/${outputFormat}`, quality);
                }
                ...
                if (!thumbnailDataUrl) {
                    ...
                    if (outputFormat === 'webp') {
                        thumbnailDataUrl = await canvasToWebP(thumbCanvas, 0.5);
                    } else {
        ...
        Swal.fire({
            ...
            text: 'Your PDF has been successfully converted to WebP images.',
            icon: 'success',
...
// Helper function to convert canvas to WebP with quality
...
function createImagePreview(dataUrl, pageNum, fileName) {
    ...
    downloadBtn.addEventListener('click', (e) => {
        ...
        a.href = dataUrl;
        a.download = `${fileName.replace('.pdf', '')}_page${pageNum}.webp`;
