...
$page_title = "Personal Loan Calculator"; // You may Change the Title here
$page_description = "Personal Loan Calculator online."; // Put your Description here
$page_keywords = "personal loan calculator, EMI calculator, loan EMI, loan interest, personal loan, financial planning";
        ...
        <div class="row justify-content-center px-2">
            <div class="col-12 p-3 p-md-4 rounded shadow">
                <div class="text-center mb-4 mb-md-5">
                    <h1 class="h2 fw-bold text-gray-800 mb-2">Personal Loan Calculator</h1>
                        ...
                        <div class="p-4 rounded border">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <input type="range" id="loan-amount" min="50000" max="5000000" step="10000" value="500000" class="form-range mt-2">
                                </div>

                                <div>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <label for="interest-rate" class="form-label mb-1">Interest Rate</label>
                                        <span class="h5 fw-semibold text-primary"><span id="interest-rate-text">12.0</span> %</span>
                                    </div>
                                    <input type="range" id="interest-rate" min="8" max="25" step="0.1" value="12.0" class="form-range mt-2">
                                </div>

                                <div>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <label for="loan-tenure" class="form-label mb-1">Loan Tenure (Years)</label>
                                        <span class="h5 fw-semibold text-primary"><span id="loan-tenure-text">3</span> Years</span>
                                    </div>
                                    <input type="range" id="loan-tenure" min="1" max="7" step="1" value="3" class="form-range mt-2">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8 border shadow-sm">
            <article>
                ...
                <?php include '../../views/content/personal-loan-calculator-content.php'; ?>
...
<script>
// JavaScript for Personal Loan Calculator
let loanChart; // Variable to hold the Chart.js instance
...
function generateAmortizationSchedule(principal, monthlyInterestRate, loanTenureMonths, emi) {
    ...
    for (let year = 1; year <= loanTenureMonths / 12; year++) {
        ...
        for (let month = 1; month <= 12; month++) {
            ...
            if (emi > remainingBalance + interestForMonth && month === 12) { // Edge case for last year if EMI is too high
                 principalForMonth = remainingBalance;
            }
...
function updateChart(principal, totalInterest) {
    ...
    if (loanChart) {
        loanChart.destroy(); // Destroy existing chart before creating a new one
    }
